...
public class mgduasusunhurufDB : MonoBehaviour
{
    ...
    string str = "";
    public string word, word2, word3, word4, word5, word6, word7, word8;
    ...
    public void Check()
    {
        ...
        if ((word == str) || (word2 == str) || (word3 == str) || (word4 == str) || (word5 == str) || (word6 == str) || (word7 == str) || (word8 == str))
        {
