...
public class mgduasusunhurufE : MonoBehaviour
{
    public GameObject lettreOne, lettreTwo, lettreThree, lettreFour, lettreFive, lettreSix, BoxOne, BoxTwo, BoxThree, BoxFour, BoxFive, BoxSix;

    Vector3 lettreOneIni, lettreTwoIni, lettreThreeIni, lettreFourIni, lettreFiveIni, lettreSixIni;

    string str = "";
    public string word, word2;
    ...
    Vector3 iniScaleLettreOne, iniScaleLettreTwo, iniScaleLettreThree, iniScaleLettreFour, iniScaleLettreFive, iniScaleLettreSix;
