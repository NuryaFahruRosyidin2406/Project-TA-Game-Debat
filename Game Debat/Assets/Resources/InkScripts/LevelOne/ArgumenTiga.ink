...
{ChangeTime(4)}
Siswa hanya akan fokus kepada hasilnya, yaitu berupa nilai yang tinggi, bukan kepada proses belajarnya. 
...
* [Hasil membantu fokus terhadap proses]
{ChangeScript("PilihanSatu.3")}

* [Hasil lebih penting daripada proses]
{ChangeScript("PilihanDua.3")}